...
openssl x509 -req -sha256 -in Attestation.csr -out Attestation.pem -CA AttestationCA.pem -CAkey AttestationCA.key -days 10000 -set_serial 10 -extfile v3.ext
...
openssl x509 -inform PEM -in Attestation.pem -out Attestation.der -outform DER
