RDEPENDS:${PN} += "powerapp"
RDEPENDS:${PN} += "powerapp-powerconfig"
RDEPENDS:${PN} += "powerapp-reboot"
RDEPENDS:${PN} += "powerapp-shutdown"
RDEPENDS:${PN} += "reboot-daemon"
RDEPENDS:${PN} += "system-core-usb"
...
# 2.0 version, don't add "RDEPENDS:${PN} += "system-core-libcutils" and
# "RDEPENDS:${PN} += "system-core-liblog" to here, otherwise, add them to here.
RDEPENDS:${PN} += "${@bb.utils.contains('PREFERRED_VERSION_system-core', '2.0', '', 'system-core-liblog system-core-libcutils', d)}"
