...
do_rootfs[depends] += "mdm9x50-image-initramfs:do_rootfs"
do_rootfs[depends] += "mdm9x50-image-minimal:do_rootfs"

rootfs_symlink() {
    # Provide minimal image as rootfs symlink
    ln -sf ${IMAGE_LINK_NAME}.default ${DEPLOY_DIR_IMAGE}/rootfs-${IMAGE_TYPE}
}
